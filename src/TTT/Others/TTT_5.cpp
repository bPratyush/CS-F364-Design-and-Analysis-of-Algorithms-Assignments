...
// This version computes Extu once and then updates it in-place.
void EXPAND(unordered_set<int> SUBG, unordered_set<int> CAND, vector<unordered_set<int>>& adj) {
    ...
    while(!Extu.empty()){
        ...
        // Compute SUBGq = { v in SUBG : v adjacent to q }
        ...
        // Compute CANDq = { v in CAND : v adjacent to q }
...
// It prints debug messages (using iterators for ordering).
