...
// Merge thread-local aggregator into globals (in critical section)
...
// Outer BronKerbosch using degeneracy ordering with OpenMP parallelization.
...
int main(int argc, char* argv[]) {
    ...
    // Build and optimize adjacency list using vector<int>
